    ...
    <div style={{ display: "flex", flexDirection: "column", gap: "12px", marginBottom: "20px", fontFamily: "'Plus Jakarta Sans', -apple-system, sans-serif" }} className="no-print">
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", width: "100%" }}>
        ...
        <div 
          ...
          title="Bật/Tắt nhạc"
        >
          <div style={{ width: '40px', height: '40px', borderRadius: '12px', background: 'linear-gradient(135deg, #fef08a 0%, #eab308 100%)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '22px', boxShadow: '0 2px 10px rgba(234, 179, 8, 0.5)', transform: isPlaying ? 'scale(1.05)' : 'none', transition: 'all 0.3s ease' }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
          ...
          {/* Profile KHÔNG còn chứa Menu nữa, chỉ hiển thị thông tin ca */}
          ...
          {/* NÚT ĐĂNG XUẤT (ICON NÚT NGUỒN SVG) */}
      ...
      {/* ==========================================
          DÒNG 2: NÚT MENU TÍNH NĂNG (NẰM BÊN TRÁI, DƯỚI LOGO)
          ========================================== */}
