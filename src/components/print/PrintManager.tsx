...
{printMode === 'customer_card' && printCustomer && (
   <div className="print-card-container" style={{ position: "fixed", bottom: "-9999px", left: "-9999px" }}> 
     {/* Ép trình duyệt render ngầm ở một vị trí vô hình thay vì ẩn display:none hoàn toàn */}
