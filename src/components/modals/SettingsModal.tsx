...
export const SettingsModal: React.FC<SettingsModalProps> = ({
  ...
  newAdminPinInput, setNewAdminPinInput, saveSettings, loading
}) => {
  ...
  return (
    <div 
      className="no-print" 
      style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,0.6)", display: "flex", justifyContent: "center", alignItems: "center", zIndex: 99999 }}
      onClick={() => setShowSettings(false)}
    >
      <div 
        style={{ background: "#ffffff", width: "550px", maxWidth: "95vw", maxHeight: "90vh", borderRadius: "12px", display: "flex", flexDirection: "column", overflow: "hidden", boxShadow: "0 20px 25px -5px rgba(0,0,0,0.2)" }} 
      ...
      >
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "10px", marginBottom: "10px" }}>
              <div>
                ...
                <select 
                  ...
                  style={{ width: "100%", padding: "10px", borderRadius: "6px", border: "1px solid #cbd5e1", outline: "none", fontSize: "14px", boxSizing: "border-box" }}
                >
                  ...
                  <optgroup label="Ví Điện Tử (Nếu VietQR hỗ trợ)">
                    <option value="970490">Viettel Money (ViettelPay)</option>
          ...
          <div style={{ background: "#fef2f2", padding: "16px", borderRadius: "10px", border: "1px solid #fecaca" }}>
            ...
            <div>
              ...
              <input 
                ...
                style={{ width: "100%", padding: "10px", borderRadius: "6px", border: "2px solid #fda4af", outline: "none", letterSpacing: "2px", fontWeight: "bold", textAlign: "center", boxSizing: "border-box" }}
              />
            </div>
          </div>
        ...
        {/* NÚT LƯU LUÔN NỔI LÊN TRÊN Ở ĐÁY MODAL */}
        <div style={{ padding: "16px 20px", borderTop: "1px solid #e2e8f0", display: "flex", gap: "12px", background: "#f1f5f9" }}>
          ...
          <button 
            ...
            disabled={loading} 
            style={{ flex: 2, padding: "12px", background: "#10b981", color: "white", border: "none", borderRadius: "8px", fontWeight: "bold", cursor: loading ? "not-allowed" : "pointer", boxShadow: "0 4px 6px rgba(16,185,129,0.3)", opacity: loading ? 0.7 : 1 }}
          >
