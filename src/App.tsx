...
export default function App() {
  ...
  // ĐÃ KHÔI PHỤC HÀM ADDEXPENSE TRÍ MẠNG Ở ĐÂY
  ...
  const renderModals = () => {
    return (
      <>
        {/* MODAL CHI PHÍ: ĐÃ CÓ LẠI HÀM ADDEXPENSE XỊN */}
