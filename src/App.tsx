...
export default function App() {
  ...
  // States dành riêng cho Phiếu nhập PO (ĐÃ RÚT RA TOP-LEVEL ĐỂ TRÁNH LỖI HOOKS)
    ...
    <div onClick={() => { setOpenFilter(null); setShowSuggestions(false); setShowMainMenu(false) }}>
      ...
      {!isLoggedIn ? (
        ...
        <div className="no-print" style={{ padding: "15px", position: "relative", minHeight: "100vh", overflowX: "auto" }}>
          ...
          {/* RENDER IN ẤN VÀ CỬA SỔ POPUP Ở ĐÂY ĐỂ ĐẢM BẢO KHÔNG BỊ LỖI Z-INDEX */}
          {renderPrintArea()}
          
          {/* NÚT BẤM MỞ CỬA SỔ NẰM Ở ĐÂY SẼ KHÔNG BỊ TRẮNG MÀN HÌNH NỮA */}
          ...
          {/* CÁC MODAL ĐÃ ĐƯỢC CHUẨN HÓA GIAO DIỆN */}
          {showSupplierModal && (
