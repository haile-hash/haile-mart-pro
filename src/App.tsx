...
export default function App() {
  ...
  // ===============================================
  // 🔥 HIỂN THỊ HÓA ĐƠN CHI TIẾT THEO YÊU CẦU
  // ===============================================
  const handleReprint = (timeStr: string) => {
    ...
    if (cName !== "Khách lẻ") {
       ...
       else { cPhone = cName; } // Fallback nếu chuỗi cũ chỉ lưu mỗi SĐT
    }
  ...
  // ===============================================
  // 🔥 RENDER GIAO DIỆN CHÍNH (IN ẤN FULL THÔNG TIN)
  // ===============================================
