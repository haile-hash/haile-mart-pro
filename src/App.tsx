    ...
    <div onClick={() => { setOpenFilter(null); setShowSuggestions(false); setShowMainMenu(false) }}>
      ...
      {isLoggedIn && (
        <button 
          ...
          style={{ position: 'absolute', top: '90px', left: '100px', zIndex: 900, background: '#0ea5e9', color: '#fff', border: 'none', borderRadius: '8px', padding: '10px 15px', fontWeight: 'bold', boxShadow: '0 4px 6px -1px rgba(14, 165, 233, 0.3)', cursor: 'pointer', display: 'flex', alignItems: 'center', gap: '6px', transition: 'all 0.2s', fontSize: '13px' }}
