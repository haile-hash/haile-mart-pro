...
// SỬA LỖI TẠI ĐÂY: Đổi tên thành MainApp để không bị trùng export default
function MainApp() {
  const VAT_RATE = 0.1;
...
// EXPORT ĐÚNG 1 TÊN CHUẨN ĐỂ VERCEL ĐỌC ĐƯỢC (KHÔNG LỖI INDEX.TSX NỮA)
