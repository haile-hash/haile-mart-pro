...
export default function App() {
  ...
  // 🔥 BẢO MẬT TUYỆT ĐỐI: Lấy trực tiếp từ Vercel, KHÔNG CÓ MÃ CỨNG DỰ PHÒNG
  ...
  return (
    <div onClick={() => { setOpenFilter(null); setShowSuggestions(false); setShowMainMenu(false) }}>
      ...
      <HandoverModal role={role} shift={shift} startingCash={startingCash} currentShiftStats={currentShiftStats} showModal={showHandoverModal} onClose={() => setShowHandoverModal(false)} onConfirm={confirmHandover} />
