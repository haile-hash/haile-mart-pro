...
export default function App() {
  ...
  return (
    <div onClick={() => { setOpenFilter(null); setShowSuggestions(false); setShowMainMenu(false) }}>
      ...
      {showExpenseModal && <ExpenseModal showExpenseModal={showExpenseModal} setShowExpenseModal={setShowExpenseModal} expName={expName} setExpName={setExpName} expAmount={expAmount} setExpAmount={setExpAmount} expenses={expenses} addExpense={addExpense} deleteExpense={deleteExpense} />}
      ...
      <AuditModal showAuditModal={showAuditModal} setShowAuditModal={setShowAuditModal} auditLogs={auditLogs} exportAuditToCSV={exportAuditToCSV} setSelectedAuditLog={setSelectedAuditLog} selectedLog={selectedAuditLog} setSelectedLog={setSelectedAuditLog} onViewDetail={setSelectedAuditLog} onRowClick={setSelectedAuditLog} />
      ...
      {/* CÁC MODAL CẦN HIỂN THỊ TRƯC TIẾP TRONG APP.TSX MÀ KHÔNG GÂY LỖI HOOKS */}
      {showSupplierModal && (
              ...
              <div style={{ background: 'white', padding: '24px', borderRadius: '12px', border: '1px solid #e2e8f0', marginBottom: '20px' }}>
                ...
                <div className="custom-input-group">
                  ...
                  <select className="custom-input" value={newBankBin} onChange={e => setNewBankBin(e.target.value)}>
                    ...
                    <option value="970436">Vietcombank</option><option value="970415">VietinBank</option><option value="970418">BIDV</option><option value="970405">Agribank</option><option value="970422">MBBank (Ngân hàng Quân đội)</option><option value="970407">Techcombank</option><option value="970416">ACB</option><option value="970432">VPBank</option><option value="970423">TPBank</option><option value="970403">Sacombank</option><option value="970437">HDBank</option><option value="970441">VIB</option><option value="970443">SHB</option><option value="970440">SeABank</option><option value="970426">MSB</option><option value="970448">OCB</option><option value="970431">Eximbank</option><option value="970429">SCB</option><option value="970449">LPBank (LienVietPostBank)</option><option value="970439">PVcomBank</option><option value="970409">Bac A Bank</option><option value="970419">NCB</option><option value="970438">BaoViet Bank</option><option value="970427">Viet A Bank</option><option value="970452">Kienlongbank</option><option value="970400">Saigonbank</option><option value="970428">Nam A Bank</option><option value="970406">DongA Bank</option><option value="970433">Vietbank</option><option value="970425">ABBank</option>
                  </select>
                </div>
